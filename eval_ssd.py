...
from vision.utils import box_utils, measurement
...
parser.add_argument('--net', default="mb2-ssd-lite",
                    help="The network architecture is mb2-ssd-lite.")
...
def compute_average_precision_per_class(num_true_cases, gt_boxes, difficult_cases,
    ...
    if use_2007_metric:
        return measurement.compute_voc2007_average_precision(precision, recall)
    else:
        return measurement.compute_average_precision(precision, recall)
...
if __name__ == '__main__':
    ...
    if args.dataset_type == "voc":
    	...
    	logging.fatal("Other dataset types not supported. Must be VOC")
    ...
    if args.net == 'mb2-ssd-lite':
        ...
        logging.fatal("The net type is wrong. Only mb2-ssd-lite is supported")
        parser.print_help(sys.stderr)
        sys.exit(1)  
